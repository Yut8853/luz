...
import MenuClassic from "./components/MenuClassic.js";
import SliderFullpageBackgroundsMask from "./components/SliderFullpageBackgroundsMask.js";
import SliderFullpageBackgroundsSlide from "./components/SliderFullpageBackgroundsSlide.js";
import SliderTestimonials from "./components/SliderTestimonials.js";
import InfiniteList from "./components/InfiniteList.js";
import CurtainsBase from "./components/CurtainsBase.js";
import SplitCounter from "./components/SplitCounter.js";
import MarqueeHeader from "./components/MarqueeHeader.js";
import MarqueeHeadingsHover from "./components/MarqueeHeadingsHover.js";
import ScreensWall from "./components/ScreensWall.js";
import RotatingButton from "./components/RotatingButton.js";
import ArcImages from "./components/ArcImages.js";
...
import PSWP from "./components/PSWP.js";
import GMap from "./components/GMap.js";
import FormAJAX from "./components/FormAJAX.js";
import Grid from "./components/Grid.js";
import AutoScrollNext from "./components/AutoScrollNext.js";
import FixedHeader from "./components/FixedHeader.js";
import FixedWall from "./components/FixedWall.js";
import CounterUp from "./components/CounterUp.js";
import SliderImages from "./components/SliderImages.js";
import ClickAndHold from "./components/ClickAndHold.js";
...
// Export the componentsMap if needed
...
window.app = {
  ...
  init: () => {
    ...
    app
      ...
      .then(() => Promise.all([app.loadScroll(), app.loadHeader()]))
      .then(
        () =>
      ...
      .then(() =>
        Promise.all([app.setLoaded(), app.loadAJAX(), app.loadCursor()])
      )
      .then(() => {
        app.loadLazy();
        app.initOnce();
  ...
  checkIsLocalFile: () => {
    if (window.location.protocol === "file:") {
      const labelElement = document.createElement("div"),
        ...
        helpURL =
          "https://docs.artemsemkin.com/asli/html/getting-started/classic-workflow.html",
  ...
  shouldLoadGUI: () => {
    ...
    return (
      currentURL.searchParams.has("gui") &&
      currentURL.searchParams.get("gui") !== "false"
    );
  },
  ...
  shouldLoadSmoothScroll() {
    return (
      ...
      app.utilities.isEnabledOption(app.options.smoothScroll)
    );
  },
  ...
  shouldNotLoadCursor() {
    return (
      !app.options.cursorFollower ||
      (!!app.options.cursorFollower && !app.options.cursorFollower.enabled)
    );
  },

  shouldLoadCursor() {
    return (
      app.utilities.isEnabledOption(app.options.cursorFollower) &&
      !!app.options.cursorFollower.matchMedia
    );
  },
    ...
    return new Promise((resolve) => {
      if (!!app.options.preloadComponents && container instanceof HTMLElement) {
        const nextComponents = [
          ...container.querySelectorAll("[data-arts-component-name]"),
        ];
        const rel = "preload";
