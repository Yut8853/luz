...
class Preloader extends BaseComponent {
  ...
  _onFinishLoading() {
    const finalOffset =
      typeof this.options.finalOffset === "string" ||
      typeof this.options.finalOffset === "number"
        ? this.options.finalOffset
        : undefined;

    if (this.elements.counterEnd.length) {
      // Animate in
      this.tl.to(
        this.elements.counterEnd,
        {
          y: "0%",
          duration: 0.6,
          ease: "expo.inOut",
    ...
    if (this.elements.contentLoaded.length) {
      this.tl.animateLines(
        this.elements.contentLoaded,
        {
          duration: 1.2,
          ease: "expo.out",
        },
    ...
    if (this.elements.wrapperImagesOuter.length) {
      this.tl.hideMask(
        this.elements.wrapperImagesOuter,
        {
          animateTo: "top",
          duration: 1.2,
          ease: "expo.in",
